...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/sinkline/chat/rails-chat-tutorial/redis-5.0.5/deps/jemalloc/ /home/sinkline/chat/rails-chat-tutorial/redis-5.0.5/deps/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/sinkline/chat/rails-chat-tutorial/redis-5.0.5/deps/jemalloc/ /home/sinkline/chat/rails-chat-tutorial/redis-5.0.5/deps/jemalloc/
