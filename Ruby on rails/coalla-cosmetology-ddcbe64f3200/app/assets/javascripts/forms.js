(function ($) {
  var updateValidDisabled = function (f, r) {
      if (r.prop("disabled")) {
  ...
  // .. Button
  //
  var ButtonHandler = function (tag) {
    this.$tag = $(tag);
  ...
  // .. Textarea
  //
  var TextareaHandler = function (tag) {
    this.$tag = $(tag);
    this.$el = this.$tag.closest(".js-form_el");
  ...
  // .. Checkbox
  //
  var CheckboxHandler = function (tag) {
    this.$tag = $(tag);
    this.$el = this.$tag.closest(".js-form_el");
  ...
  RadioHandler.prototype.change = function () {
    var form = this.$tag.closest("form"),
  ...
  // .. Select
  //
  var SelectHandler = function (tag) {
    this.$tag = $(tag);
    this.$el = this.$tag.closest(".js-form_el");
  ...
  SelectHandler.prototype.refresh = function () {
    var text = this.$tag.children("option:selected").text();
  ...
  var refreshElements = function (selector, type) {
      this.find(selector)
    ...
    methods = {
      ...
      refresh: function () {
        return this.each(function () {
          var r = refreshElements.bind($(this));
